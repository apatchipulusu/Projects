...
class TheNode(object):
  ...
  def main_loop(self):
    ...
    while not rospy.is_shutdown():
      ...
      #Added code to read and publish the line sensor data 
      msg.lineSensor0 = self.readFourByteAndChecksum()
      msg.lineSensor1 = self.readFourByteAndChecksum()
      msg.lineSensor2 = self.readFourByteAndChecksum()
      msg.lineSensor3 = self.readFourByteAndChecksum()
      msg.lineSensor4 = self.readFourByteAndChecksum()

      #Added code to read and publsh the ir sensor data
      msg.irInput = self.readFourByteAndChecksum()
